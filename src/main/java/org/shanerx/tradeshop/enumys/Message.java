...
public enum Message {
    ...
    NO_COMMAND_PERMISSION(MessageSectionKeys.NONE, "&cYou do not have permission to execute this command", "Text to display when a player attempts to run administrator commands:"),
    NO_SHOP_PERMISSION(MessageSectionKeys.NONE, "&cYou do not have permission to edit that shop."),
    NO_TRADE_PERMISSION(MessageSectionKeys.NONE, "&cYou do not have permission to trade with TradeShops", "Text to display when a player attempts to trade while having the `Prevent Trade` permission:"),
